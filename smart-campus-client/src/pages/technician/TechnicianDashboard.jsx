...
const STAT_CARDS = [
  { label: 'Assigned to Me', icon: Wrench, color: 'text-amber-400', bg: 'bg-amber-500/10', value: '—' },
  { label: 'In Progress', icon: Clock, color: 'text-blue-400', bg: 'bg-blue-500/10', value: '—' },
  { label: 'Resolved Today', icon: CheckCircle, color: 'text-emerald-400', bg: 'bg-emerald-500/10', value: '—' },
]
      ...
      <div className="max-w-5xl mx-auto px-4 pt-24 pb-16">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
          ...
          <div className="text-center py-8 text-slate-600 text-sm">
            Tickets assigned to you will appear here.<br />

      ...
      <div className="max-w-7xl mx-auto px-4 py-8 pt-16">
        ...
        <div className="flex justify-between items-center mb-8 mt-4">
          <div>
            ...
            <p className="text-slate-400 mt-1">Add, edit and manage campus resources</p>
          </div>
          <button
              ...
              <tbody>
                {resources.map((r) => (
                  <tr key={r.id} className="border-t border-slate-700 hover:bg-slate-700/30">
                    ...
                    <td className="px-4 py-3 text-slate-300">{r.resourceCode}</td>
                    <td className="px-4 py-3 text-slate-300">{r.type.replace('_', ' ')}</td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="bg-blue-600/20 hover:bg-blue-600/40 text-blue-400 px-3 py-1 rounded-lg text-xs transition"
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => handleDelete(r.id)}
                          className="bg-red-600/20 hover:bg-red-600/40 text-red-400 px-3 py-1 rounded-lg text-xs transition"
                        >
                          Delete
                        </button>
                      </div>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-slate-400 text-sm block mb-1">Resource Code *</label>
                <input
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-slate-400 text-sm block mb-1">Available From</label>
                  <input
                    type="time"
                ...
                <div>
                  <label className="text-slate-400 text-sm block mb-1">Available Until</label>
                  <input
                    type="time"
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 bg-slate-600 hover:bg-slate-500 text-white py-2 rounded-lg text-sm transition"
              >
                Cancel
              </button>
            </div>
